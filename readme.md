...
There are a number of parameters to the DataStreamWriter configuration:
  ...
  * The file format and final destination of files
  ...
  A <a href="https://spark.apache.org/docs/latest/api/python/pyspark.sql.html?highlight=foreach#pyspark.sql.streaming.DataStreamWriter.foreach"target="_blank">custom sink via `writeStream.foreach(...)`</a>
